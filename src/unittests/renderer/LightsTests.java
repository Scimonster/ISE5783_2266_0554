...
public class LightsTests {
   ...
   public void triangleEverything(){
      scene2.geometries.add(triangle1, triangle2);
      scene2.addLightSource(
              new SpotLight(trianglesLightColor, new Point(-30, -10, -100), trianglesLightDirection)
              .setKl(0.0005).setKq(0.00003),
              new PointLight(trianglesLightColor, new Point(30, 25, -100))
              .setKl(0.02).setKq(0.000001),
              new DirectionalLight(sphereLightColor,new Vector(10,15,-2))
      ) ;
