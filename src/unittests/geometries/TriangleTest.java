...
class TriangleTest {
    ...
    void testFindIntersections()
    {
        ...
        assertNull(T1.findIntersections(new Ray(new Point(0,2,0), v1)), "Should return 0 points");
        ...
        List<Point> result=T1.findIntersections(new Ray(new Point(0.5, 0.5, 0), v1));
